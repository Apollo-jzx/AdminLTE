                            ...
                            <div class="row form-horizontal">
                                ...
                                <div class="col-xs-12 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="title" class="form-control" placeholder="搜索标题!"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="subTitle" class="form-control" placeholder="搜索子标题!"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="titleDesc" class="form-control" placeholder="搜索标题描述!"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {"data":"titleDesc"},
            {
                "data":
                    ...
                    if (row.url == null ) {
                        ...
                        return '<a href = "'+row.url+'" target="_blank">查看地址</a>';
                    }
            },
            {
                "data":
                    function (row, type, val, meta) {
                        ...
                        return '<a href = "'+row.pic+'" target="_blank">查看图片1</a>';
                    }
            },
            {
                "data":
                    function (row, type, val, meta) {
                        ...
                        return '<a href = "'+row.pic2+'" target="_blank">查看图片2</a>';
                    }
            },
            {
                "data":
...

            {
                "data": function (row, type, val, meta) {
                    ...
                    return ' <button type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\''+detailUrl+'\');"><i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;' +
                        ...
                        '<a type="button" class="btn btn-sm btn-danger" onclick="App.deleteSingle(\''+deleteUrl+'\',\''+row.id+'\')"><i class="fa fa-trash"></i> 删除</a>'
                }
            }
